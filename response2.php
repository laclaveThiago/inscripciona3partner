<?php
	...
	if ($conn->connect_error) {
		...
		$sesion3 = $conn->real_escape_string($_POST['sesion1']);
		$sesion4 = $conn->real_escape_string($_POST['sesion2']);
		...
		if(strlen($_POST['2asistirassesiones']) > 0){
			...
			$sesion32 = $conn->real_escape_string($_POST['2sesion1']);
			$sesion42 = $conn->real_escape_string($_POST['2sesion2']);
		...
		if(strlen($_POST['3asistirassesiones']) > 0){
			...
			$sesion33 = $conn->real_escape_string($_POST['3sesion1']);
			$sesion43 = $conn->real_escape_string($_POST['3sesion2']);
		...
		if(strlen($_POST['4asistirassesiones']) > 0){
			...
			$sesion34 = $conn->real_escape_string($_POST['4sesion1']);
			$sesion44 = $conn->real_escape_string($_POST['4sesion2']);
